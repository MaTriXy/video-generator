...
Use `mcp__video_gen_tools__svg_path` with equation: `arc`, params: `{"start_x": 100, "start_y": 300, "end_x": 400, "end_y": 300, "radius": 200, "sweep": 1, "large_arc": 0}`
...
<linear-example>
**Example - Laser beam:**
Use `mcp__video_gen_tools__svg_path` with equation: `linear`, params: `{"start_x": 100, "start_y": 100, "end_x": 700, "end_y": 400}`
...
Use `mcp__video_gen_tools__svg_path` with equation: `circular`, params: `{"center_x": 400, "center_y": 300, "radius": 150}`
...
Use `mcp__video_gen_tools__svg_path` with equation: `zigzag`, params: `{"start_x": 400, "start_y": 100, "end_x": 400, "end_y": 500, "amplitude": 80, "segments": 8}`
...
<elliptical-example>
**Example - Comet orbit:**
Use `mcp__video_gen_tools__svg_path` with equation: `elliptical`, params: `{"center_x": 400, "center_y": 300, "radius_x": 200, "radius_y": 100}`
...
Use `mcp__video_gen_tools__svg_path` with equation: `parabolic`, params: `{"start_x": 100, "start_y": 400, "end_x": 700, "end_y": 400, "arc_height": 200}`
...
Use `mcp__video_gen_tools__svg_path` with equation: `bezier`, params: `{"start_x": 100, "start_y": 400, "cp1_x": 200, "cp1_y": 100, "cp2_x": 600, "cp2_y": 100, "end_x": 700, "end_y": 400}`
...
Use `mcp__video_gen_tools__svg_path` with equation: `bounce`, params: `{"start_x": 100, "start_y": 100, "end_x": 700, "ground_y": 400, "initial_height": 250, "bounces": 4, "decay": 0.6}`
...
Use `mcp__video_gen_tools__svg_path` with equation: `s_curve`, params: `{"start_x": 100, "start_y": 200, "end_x": 700, "end_y": 500, "curvature": 0.4}`
...
Use `mcp__video_gen_tools__svg_path` with equation: `sine_wave`, params: `{"start_x": 50, "start_y": 300, "end_x": 650, "end_y": 300, "amplitude": 60, "cycles": 6}`

**Example - Wave going down (vertical):**
Use `mcp__video_gen_tools__svg_path` with equation: `sine_wave`, params: `{"start_x": 300, "start_y": 50, "end_x": 300, "end_y": 550, "amplitude": 40, "cycles": 5}`
...
Use `mcp__video_gen_tools__svg_path` with equation: `spiral`, params: `{"center_x": 400, "center_y": 300, "max_radius": 150, "revolutions": 3}`
...
Use `mcp__video_gen_tools__svg_path` with equation: `spline`, params: `{"points": [[100,300], [200,100], [300,350], [400,150], [500,300], [600,100], [700,250]], "tension": 0.3}`
